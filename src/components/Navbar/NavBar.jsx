    ...
    <header className={scrolled ? 'navbar-portfolio navbar-scroll' : 'navbar-portfolio'}>
      <div className='container-navbar'>
        ...
        <ul className="nav-list">
          ...
          <li className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('skills')}><a href="projects">Skills</a></li>
        ...
        <div className='container-social'>
          ...
          <button  onClick={() => console.log('conect')}><span>Comunicate conmigo!</span></button>
        </div>
      </div>
    </header>
  );
